...
tests, evidence, and retirement without losing the claim boundary.
...
Goal Pack charters should reference harness IDs or companion artifact paths.
Do not paste full harness DSL into `charter.yaml`.
...
- evidence records include positive tokens and negative claims;
