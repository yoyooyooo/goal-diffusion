...
| Render wiring | controls, roles, labels, dispatch, visible state | business logic |
...
- Components should render and dispatch intent. Put long-lived state,
...
async command state:
  mutation hook | action dispatcher | command service | Effect program
