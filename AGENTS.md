...
- `scripts/`：发布脚本和脚本级测试。
- `skills/`：AI Coding OS suite 的 agent skill 源码视图，按 router / goal / governance / capability / harness 分组。
- `docs/`：项目文档分层入口。先读 `docs/README.md`。
- `docs/standards/docs-governance.md`：本仓 docs layer、authority、promotion / demotion 和 audit 标准。
- `docs/standards/skill-source-distribution.md`：skill SSoT / repo mirror / runtime target 分发标准。
...
- 涉及 skill source、mirror、runtime 分发或旧入口退役时，按 `docs/standards/skill-source-distribution.md`。
